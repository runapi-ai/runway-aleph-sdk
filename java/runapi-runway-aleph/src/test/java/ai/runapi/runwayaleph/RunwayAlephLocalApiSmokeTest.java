...
import ai.runapi.runwayaleph.types.EditVideoResponse;
    ...
    class RunwayAlephLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/runway_aleph/edit_video", this::handleRequest);
        server.start();
      }
      ...
      void runUsesApacheTransportAgainstLocalApi() throws Exception {
        try (RunwayAlephClient client =
            RunwayAlephClient.builder()
                .apiKey("sk-test")
      ...
      CompletedEditVideoResponse response =
        ...
        assertEquals("/api/v1/runway_aleph/edit_video", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/runway_aleph/edit_video/task_local_123", captured.path);
